...
export const QUESTIONS = [
    new Question('q1', 'u1', ['c6', 'c11'], 'Do you think Finland has the best education in the world?', new Date(2019, 11, 12).toString(), 100, 351, 102),
    new Question('q2', 'u1', ['c3'], 'Is Harry Potter worth reading?', new Date(2020, 8, 24, 1).toString(), 46, 102, 68),
    new Question('q3', 'u1', ['c6', 'c13', 'c1', 'c2', 'c3', 'c4', 'c5', 'c7', 'c8', 'c9'], 'Should we send our kids to school during COVID?', new Date(2018, 10, 12).toString(), 3246, 3461, 230),
